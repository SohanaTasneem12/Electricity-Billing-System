...
public class CalculateBill extends JFrame implements ActionListener{
    ...
    JTextField tfname, tfaddress, tfunit, tfdivision, tfemail,tfphone;
    JButton next, cancel;
     JLabel lblmeter,lblname,lblmeternumber,labeladdress;
    ...
    CalculateBill() {
        ...
        heading.setBounds(180,10,400,40);
        ...
        JLabel lbldivision = new JLabel("Month");
        lbldivision.setBounds(100, 240,100,20);
        p.add(lbldivision);
        ...
        if(ae.getSource()== next) {
            ...
            try {
                ...
                while(rs.next()) {
                    ...
                    totalbill += Integer.parseInt(rs.getString("bd_cess"));
