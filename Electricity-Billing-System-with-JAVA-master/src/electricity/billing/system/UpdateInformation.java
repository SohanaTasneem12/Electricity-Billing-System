...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    JTextField tfaddress,tfcity,tfdivision,tfemail,tfphone;
    ...
    UpdateInformation(String meter) {
        ...
        lbldivision.setBounds(30,230,100,20);
        add(lbldivision);
        
        tfdivision = new JTextField("");
        tfdivision.setBounds(230,230,200,20);
        add(tfdivision);
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == update) {
             ...
             try {
                 Conn c = new Conn();
                 c.s.executeUpdate("update customer set address = '"+address+"', city = '"+city+"', division = '"+division+"', email = '"+email+"', phone = '"+phone+"' where meter_no = '"+meter+"'");
