...
public class NewCustomer extends JFrame implements ActionListener{
    ...
    JTextField tfname, tfaddress, tfcity, tfdivision, tfemail,tfphone;
    JButton next, cancel;
     JLabel lblmeter;
    ...
    NewCustomer() {
        ...
        tfdivision.setBounds(240, 240, 200,20);
        p.add(tfdivision);
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource()== next) {
            ...
            String query1 = "insert into customer values('"+name+"','"+meter+"','"+address+"','"+city+"','"+division+"','"+email+"','"+phone+"')";
